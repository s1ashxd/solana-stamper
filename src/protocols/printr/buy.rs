...
use super::constants::{DAMM_V2_PROGRAM, DBC_PROGRAM, PRINTR_PROGRAM, PRINTR_SWAP_DISC, SWAP_INTENT_SPEND_QUOTE};
use super::pda::{damm_event_authority, dbc_event_authority, printr_authority};

#[must_use]
pub fn buy_spec(payer: Pubkey, base_token_program: TokenProgram, lut: LookupTable) -> TemplateSpec {
